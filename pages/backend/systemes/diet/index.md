...
**Type :** Utilisateur
**Référence spec :** `reference/diagrammes/workflow_gestion-dietplan-et-lancement.mermaid` · `reference/diagrammes/workflow_terminer-diet.mermaid` · `docs/pages/backend/design/design-domain.md#diet`
