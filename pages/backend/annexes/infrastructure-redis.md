...
> `workflow-cache-recherche-aliments.md`. Ce document-ci ne sert qu'à approfondir la brique.
>
...
> `workflow-cache-recherche-aliments.md`. Ce document n'en décrit que les conséquences pratiques.
...
`workflow-cache-recherche-aliments.md`). Mais **chaque requête tente d'abord de joindre Redis** et
...
| Sujet | Document |
|---|---|
| Le fonctionnement du cache de bout en bout | `workflow-cache-recherche-aliments.md` |
| Le besoin et le périmètre du cache | `features/interne/recherche-aliments-cache.md` |
| Le job qui invalide le cache après import | `workflow-import-aliments.md` |
| Ports, docker-compose, manifests K3s | `infrastructure-setup.md` |
