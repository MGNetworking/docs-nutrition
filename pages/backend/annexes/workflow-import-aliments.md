...
**Feature associée :** `features/interne/mise-a-disposition-aliments.md`
**Ticket :** NTR-55

> **Ce document explique comment le système fonctionne, de bout en bout.**
> Les deux annexes voisines décrivent chacune une brique isolée : `infrastructure-hangfire.md`
> le **moteur de jobs**, `infrastructure-import-off.md` la **source de données**. Ce document-ci
...
7. **Invalidation du cache** — si au moins un produit a été importé, toutes les recherches en
   ...
   Voir `workflow-cache-recherche-aliments.md`.
...
| Sujet | Document |
|---|---|
| Le moteur de jobs (Hangfire, dashboard, tables) | `infrastructure-hangfire.md` |
| La source de données (pourquoi un dump, quels champs) | `infrastructure-import-off.md` |
| Le besoin métier et le périmètre | `features/interne/mise-a-disposition-aliments.md` |
| La recherche d'aliments qui consomme le catalogue | `features/utilisateur/aliments.md` |
| Le cache des recherches, invalidé en fin d'import | `workflow-cache-recherche-aliments.md` |
| L'endpoint de santé système | `features/interne/admin-dashboard.md` |
