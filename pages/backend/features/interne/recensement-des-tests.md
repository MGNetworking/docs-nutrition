...
**Type :** Interne
**Référence spec :** [`niveaux-de-tests.md`](niveaux-de-tests.md)

> **Portée de ce document : la liste des tests à écrire et leur avancement.**
> Il ne définit pas les niveaux — pour comprendre ce qu'est chaque niveau et où s'arrête son
> périmètre, lire d'abord [`niveaux-de-tests.md`](niveaux-de-tests.md).
...
> Restriction : `[Authorize]` — orchestration Redis + PostgreSQL (voir `annexes/workflow-cache-recherche-aliments.md`)
