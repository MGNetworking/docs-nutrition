...
> Configuration technique (middleware, JWT, Swagger) : [Design technique — Infrastructure couche API](design-api-infrastructure.md)
...
DTO retourné par le service : `UserExportResponse` — voir [RGPD — Droits de l'utilisateur](../systemes/rgpd/index.md) pour l'implémentation complète (principe en mémoire, ZipArchive, responsabilités par couche).
